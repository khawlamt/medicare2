...
<div class="card">
    <div class="card-header bg-white py-3">
        <h5 class="mb-0 fw-semibold">
            <i class="bi bi-pencil text-warning me-2"></i>Modifier — {{ $hospital->nom }}
        </h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('hospitals.update', $hospital) }}">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nom" value="{{ old('nom', $hospital->nom) }}"
                ...
                <div class="col-md-6">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror">
                        ...
                        <option value="prive" {{ old('type', $hospital->type) == 'prive' ? 'selected' : '' }}>Privé</option>
                    </select>
                    @error('type')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label">Ville <span class="text-danger">*</span></label>
                    <input type="text" name="ville" value="{{ old('ville', $hospital->ville) }}"
                ...
                <div class="col-md-6">
                    ...
                    <select name="gouvernorat" class="form-select @error('gouvernorat') is-invalid @enderror">
                        ...
                        @foreach($gouvernorats as $gov)
                            <option value="{{ $gov }}" {{ old('gouvernorat', $hospital->gouvernorat) == $gov ? 'selected' : '' }}>
                                {{ $gov }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="adresse" value="{{ old('adresse', $hospital->adresse) }}"
                           class="form-control" placeholder="Adresse complète">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Téléphone</label>
                    <input type="text" name="telephone" value="{{ old('telephone', $hospital->telephone) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="latitude" value="{{ old('latitude', $hospital->latitude) }}" step="0.00000001"
                           class="form-control" placeholder="Ex: 36.8065">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Longitude</label>
                    <input type="number" name="longitude" value="{{ old('longitude', $hospital->longitude) }}" step="0.00000001"
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" rows="3"
                              class="form-control"
                              placeholder="Informations supplémentaires...">{{ old('description', $hospital->description) }}</textarea>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-4">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="urgence" id="urgence"
                                       value="1" {{ old('urgence', $hospital->urgence) ? 'checked' : '' }}>
                        ...
                        <div class="col-4">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="maternite" id="maternite"
                                       value="1" {{ old('maternite', $hospital->maternite) ? 'checked' : '' }}>
                        ...
                        <div class="col-4">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="chirurgie" id="chirurgie"
                                       value="1" {{ old('chirurgie', $hospital->chirurgie) ? 'checked' : '' }}>
